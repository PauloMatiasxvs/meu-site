...
import { JoinTeamRequest$outboundSchema, JoinTeamResponseBody$inboundSchema, } from "../models/jointeamop.js";
 ...
 */
export async function teamsJoinTeam(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, JoinTeamResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([402, 403, "4XX"]), M.jsonErr(404, VercelNotFoundError$inboundSchema), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
}
//# sourceMappingURL=teamsJoinTeam.js.map