...
import { SubmitInvoiceRequest$outboundSchema, SubmitInvoiceResponseBody$inboundSchema, } from "../models/submitinvoiceop.js";
 ...
 */
export async function marketplaceSubmitInvoice(client, request, options) {
    ...
    const path = pathToFunc("/v1/installations/{integrationConfigurationId}/billing/invoices")(pathParams);
    ...
    const [result] = await M.match(M.json(200, SubmitInvoiceResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
}
//# sourceMappingURL=marketplaceSubmitInvoice.js.map