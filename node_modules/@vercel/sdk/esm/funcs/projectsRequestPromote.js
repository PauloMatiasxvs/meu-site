...
import { RequestPromoteRequest$outboundSchema, } from "../models/requestpromoteop.js";
 ...
 */
export async function projectsRequestPromote(client, request, options) {
    ...
    const [result] = await M.match(M.nil(201, z.void()), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, 409, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
}
//# sourceMappingURL=projectsRequestPromote.js.map