...
import { CreateProjectTransferRequestRequest$outboundSchema, CreateProjectTransferRequestResponseBody$inboundSchema, } from "../models/createprojecttransferrequestop.js";
 ...
 */
export async function projectsCreateProjectTransferRequest(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, CreateProjectTransferRequestResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
}
//# sourceMappingURL=projectsCreateProjectTransferRequest.js.map