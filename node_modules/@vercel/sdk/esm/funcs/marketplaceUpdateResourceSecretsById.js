...
import { UpdateResourceSecretsByIdRequest$outboundSchema, } from "../models/updateresourcesecretsbyidop.js";
 ...
 */
export async function marketplaceUpdateResourceSecretsById(client, request, options) {
    ...
    const path = pathToFunc("/v1/installations/{integrationConfigurationId}/resources/{resourceId}/secrets")(pathParams);
    ...
    const [result] = await M.match(M.nil(201, z.void()), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, "4XX"]), M.jsonErr(404, VercelNotFoundError$inboundSchema), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
