...
import { UpdateInvoiceRequest$outboundSchema, } from "../models/updateinvoiceop.js";
 ...
 */
export async function marketplaceUpdateInvoice(client, request, options) {
    ...
    const path = pathToFunc("/v1/installations/{integrationConfigurationId}/billing/invoices/{invoiceId}/actions")(pathParams);
    ...
    const [result] = await M.match(M.nil(204, z.void()), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, "4XX"]), M.jsonErr(404, VercelNotFoundError$inboundSchema), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
}
//# sourceMappingURL=marketplaceUpdateInvoice.js.map