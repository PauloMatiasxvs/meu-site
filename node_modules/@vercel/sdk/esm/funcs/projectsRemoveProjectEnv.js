...
import { RemoveProjectEnvRequest$outboundSchema, RemoveProjectEnvResponseBody$inboundSchema, } from "../models/removeprojectenvop.js";
 ...
 */
export async function projectsRemoveProjectEnv(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, RemoveProjectEnvResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, 409, "4XX"]), M.jsonErr(404, VercelNotFoundError$inboundSchema), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
}
//# sourceMappingURL=projectsRemoveProjectEnv.js.map