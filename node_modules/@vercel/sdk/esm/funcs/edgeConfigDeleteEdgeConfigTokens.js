...
import { DeleteEdgeConfigTokensRequest$outboundSchema, } from "../models/deleteedgeconfigtokensop.js";
 ...
 */
export async function edgeConfigDeleteEdgeConfigTokens(client, request, options) {
    ...
    const [result] = await M.match(M.nil(204, z.void()), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([402, 403, "4XX"]), M.jsonErr(404, VercelNotFoundError$inboundSchema), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
