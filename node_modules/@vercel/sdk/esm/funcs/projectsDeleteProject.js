...
import { DeleteProjectRequest$outboundSchema, } from "../models/deleteprojectop.js";
 ...
 */
export async function projectsDeleteProject(client, request, options) {
    ...
    const [result] = await M.match(M.nil(204, z.void()), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, 409, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
