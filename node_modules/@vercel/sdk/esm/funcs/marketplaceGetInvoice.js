...
import { GetInvoiceRequest$outboundSchema, GetInvoiceResponseBody$inboundSchema, } from "../models/getinvoiceop.js";
...
export async function marketplaceGetInvoice(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, GetInvoiceResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, "4XX"]), M.jsonErr(404, VercelNotFoundError$inboundSchema), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
