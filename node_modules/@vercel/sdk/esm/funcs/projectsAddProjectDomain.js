...
import { AddProjectDomainRequest$outboundSchema, AddProjectDomainResponseBody$inboundSchema, } from "../models/addprojectdomainop.js";
 ...
 */
export async function projectsAddProjectDomain(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, AddProjectDomainResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([402, 403, 409, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
