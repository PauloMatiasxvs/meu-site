...
import { PutFirewallConfigRequest$outboundSchema, PutFirewallConfigResponseBody$inboundSchema, } from "../models/putfirewallconfigop.js";
 ...
 */
export async function securityPutFirewallConfig(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, PutFirewallConfigResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([402, 403, "4XX"]), M.jsonErr(404, VercelNotFoundError$inboundSchema), M.fail([500, "5XX"]))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
