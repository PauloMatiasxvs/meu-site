...
import { SubmitBillingDataRequest$outboundSchema, } from "../models/submitbillingdataop.js";
 ...
 */
export async function marketplaceSubmitBillingData(client, request, options) {
    ...
    const path = pathToFunc("/v1/installations/{integrationConfigurationId}/billing")(pathParams);
    ...
    const [result] = await M.match(M.nil(201, z.void()), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
}
//# sourceMappingURL=marketplaceSubmitBillingData.js.map