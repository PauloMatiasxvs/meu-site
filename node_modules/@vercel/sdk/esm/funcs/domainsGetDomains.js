...
import { GetDomainsRequest$outboundSchema, GetDomainsResponseBody$inboundSchema, } from "../models/getdomainsop.js";
 ...
 */
export async function domainsGetDomains(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, GetDomainsResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, 409, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
