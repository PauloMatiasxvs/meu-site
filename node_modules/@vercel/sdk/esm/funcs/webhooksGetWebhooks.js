 ...
 * Get a list of webhooks
 */
export async function webhooksGetWebhooks(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, GetWebhooksResponseBody$inboundSchema), M.jsonErr(400, VercelBadRequestError$inboundSchema), M.jsonErr(401, VercelForbiddenError$inboundSchema), M.fail([403, "4XX"]), M.fail("5XX"))(response, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
}
//# sourceMappingURL=webhooksGetWebhooks.js.map