...
/** @internal */
export declare const Roles2$inboundSchema: z.ZodType<Roles2, z.ZodTypeDef, unknown>;
/** @internal */
export type Roles2$Outbound = {
    accessGroupId: string;
};
/** @internal */
export declare const Roles2$outboundSchema: z.ZodType<Roles2$Outbound, z.ZodTypeDef, Roles2>;
/**
 * @internal
...
export declare namespace Roles2$ {
    ...
    const inboundSchema: z.ZodType<Roles2, z.ZodTypeDef, unknown>;
    /** @deprecated use `Roles2$outboundSchema` instead. */
    const outboundSchema: z.ZodType<Roles2$Outbound, z.ZodTypeDef, Roles2>;
    /** @deprecated use `Roles2$Outbound` instead. */
    type Outbound = Roles2$Outbound;
}
export declare function roles2ToJSON(roles2: Roles2): string;
export declare function roles2FromJSON(jsonString: string): SafeParseResult<Roles2, SDKValidationError>;
/** @internal */
export declare const Roles1$inboundSchema: z.ZodNativeEnum<typeof Roles1>;
/** @internal */
export declare const Roles1$outboundSchema: z.ZodNativeEnum<typeof Roles1>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
export type PatchTeamSaml$Outbound = {
    enforced?: boolean | undefined;
    roles?: {
        [k: string]: Roles2$Outbound | string;
    } | undefined;
};
/** @internal */
