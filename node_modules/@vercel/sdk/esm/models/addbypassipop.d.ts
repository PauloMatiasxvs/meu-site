...
export declare const AddBypassIpResponseBodyAction: {
    readonly Block: "block";
    readonly Bypass: "bypass";
};
export type AddBypassIpResponseBodyAction = ClosedEnum<typeof AddBypassIpResponseBodyAction>;
...
export type AddBypassIpResponseBody = AddBypassIpResponseBody2 | AddBypassIpResponseBody1;
/** @internal */
...
/** @internal */
export declare const AddBypassIpResponseBodyAction$inboundSchema: z.ZodNativeEnum<typeof AddBypassIpResponseBodyAction>;
/** @internal */
export declare const AddBypassIpResponseBodyAction$outboundSchema: z.ZodNativeEnum<typeof AddBypassIpResponseBodyAction>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace AddBypassIpResponseBodyAction$ {
...
/** @internal */
export declare const AddBypassIpResponseBodySecurityResult$inboundSchema: z.ZodType<AddBypassIpResponseBodySecurityResult, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const AddBypassIpResponseBodySecurityResult$outboundSchema: z.ZodType<AddBypassIpResponseBodySecurityResult$Outbound, z.ZodTypeDef, AddBypassIpResponseBodySecurityResult>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace AddBypassIpResponseBodySecurityResult$ {
    /** @deprecated use `AddBypassIpResponseBodySecurityResult$inboundSchema` instead. */
    const inboundSchema: z.ZodType<AddBypassIpResponseBodySecurityResult, z.ZodTypeDef, unknown>;
    /** @deprecated use `AddBypassIpResponseBodySecurityResult$outboundSchema` instead. */
    const outboundSchema: z.ZodType<AddBypassIpResponseBodySecurityResult$Outbound, z.ZodTypeDef, AddBypassIpResponseBodySecurityResult>;
    /** @deprecated use `AddBypassIpResponseBodySecurityResult$Outbound` instead. */
    type Outbound = AddBypassIpResponseBodySecurityResult$Outbound;
}
export declare function addBypassIpResponseBodySecurityResultToJSON(addBypassIpResponseBodySecurityResult: AddBypassIpResponseBodySecurityResult): string;
export declare function addBypassIpResponseBodySecurityResultFromJSON(jsonString: string): SafeParseResult<AddBypassIpResponseBodySecurityResult, SDKValidationError>;
/** @internal */
...
/** @internal */
export type AddBypassIpResponseBody$Outbound = AddBypassIpResponseBody2$Outbound | AddBypassIpResponseBody1$Outbound;
/** @internal */
