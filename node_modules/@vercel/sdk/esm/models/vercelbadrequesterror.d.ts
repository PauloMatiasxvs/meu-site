...
export type ErrorT = {
    ...
    message?: "One of the provided values in the request query, body or headers is invalid" | undefined;
};
export type VercelBadRequestErrorData = {
    error: ErrorT;
};
export declare class VercelBadRequestError extends Error {
    error: ErrorT;
...
export type ErrorT$Outbound = {
    code: "bad_request";
    message: "One of the provided values in the request query, body or headers is invalid";
};
/** @internal */
