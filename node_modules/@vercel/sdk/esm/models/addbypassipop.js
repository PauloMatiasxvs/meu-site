...
/** @internal */
export const AddBypassIpResponseBodyAction$inboundSchema = z.nativeEnum(AddBypassIpResponseBodyAction);
/** @internal */
export const AddBypassIpResponseBodyAction$outboundSchema = AddBypassIpResponseBodyAction$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var AddBypassIpResponseBodyAction$;
(function (AddBypassIpResponseBodyAction$) {
    /** @deprecated use `AddBypassIpResponseBodyAction$inboundSchema` instead. */
    AddBypassIpResponseBodyAction$.inboundSchema = AddBypassIpResponseBodyAction$inboundSchema;
    /** @deprecated use `AddBypassIpResponseBodyAction$outboundSchema` instead. */
    AddBypassIpResponseBodyAction$.outboundSchema = AddBypassIpResponseBodyAction$outboundSchema;
})(AddBypassIpResponseBodyAction$ || (AddBypassIpResponseBodyAction$ = {}));
/** @internal */
export const AddBypassIpResponseBodySecurityResult$inboundSchema = z.object({
    OwnerId: z.string(),
    Id: z.string(),
    Domain: z.string(),
    Ip: z.string(),
...
/** @internal */
export const AddBypassIpResponseBodySecurityResult$outboundSchema = z.object({
    ownerId: z.string(),
    id: z.string(),
    domain: z.string(),
    ip: z.string(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var AddBypassIpResponseBodySecurityResult$;
(function (AddBypassIpResponseBodySecurityResult$) {
    /** @deprecated use `AddBypassIpResponseBodySecurityResult$inboundSchema` instead. */
    AddBypassIpResponseBodySecurityResult$.inboundSchema = AddBypassIpResponseBodySecurityResult$inboundSchema;
    /** @deprecated use `AddBypassIpResponseBodySecurityResult$outboundSchema` instead. */
    AddBypassIpResponseBodySecurityResult$.outboundSchema = AddBypassIpResponseBodySecurityResult$outboundSchema;
})(AddBypassIpResponseBodySecurityResult$ || (AddBypassIpResponseBodySecurityResult$ = {}));
export function addBypassIpResponseBodySecurityResultToJSON(addBypassIpResponseBodySecurityResult) {
    return JSON.stringify(AddBypassIpResponseBodySecurityResult$outboundSchema.parse(addBypassIpResponseBodySecurityResult));
}
export function addBypassIpResponseBodySecurityResultFromJSON(jsonString) {
    return safeParse(jsonString, (x) => AddBypassIpResponseBodySecurityResult$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'AddBypassIpResponseBodySecurityResult' from JSON`);
}
/** @internal */
export const AddBypassIpResponseBody2$inboundSchema = z.object({
    ok: z.boolean(),
    result: z.array(z.lazy(() => AddBypassIpResponseBodySecurityResult$inboundSchema)).optional(),
});
/** @internal */
export const AddBypassIpResponseBody2$outboundSchema = z.object({
    ok: z.boolean(),
    result: z.array(z.lazy(() => AddBypassIpResponseBodySecurityResult$outboundSchema)).optional(),
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
