 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CreateProjectEnvValue2$;
(function (CreateProjectEnvValue2$) {
    /** @deprecated use `CreateProjectEnvValue2$inboundSchema` instead. */
    CreateProjectEnvValue2$.inboundSchema = CreateProjectEnvValue2$inboundSchema;
    /** @deprecated use `CreateProjectEnvValue2$outboundSchema` instead. */
    CreateProjectEnvValue2$.outboundSchema = CreateProjectEnvValue2$outboundSchema;
})(CreateProjectEnvValue2$ || (CreateProjectEnvValue2$ = {}));
/** @internal */
export const CreateProjectEnvValue$inboundSchema = z.union([z.string(), z.array(CreateProjectEnvValue2$inboundSchema)]);
/** @internal */
export const CreateProjectEnvValue$outboundSchema = z.union([z.string(), z.array(CreateProjectEnvValue2$outboundSchema)]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
