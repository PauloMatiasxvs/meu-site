...
export declare const AdditionalRoles: {
...
/** @internal */
export declare const AdditionalRoles$inboundSchema: z.ZodNativeEnum<typeof AdditionalRoles>;
/** @internal */
export declare const AdditionalRoles$outboundSchema: z.ZodNativeEnum<typeof AdditionalRoles>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace AdditionalRoles$ {
