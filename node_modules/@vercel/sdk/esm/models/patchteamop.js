...
/** @internal */
export const Roles2$outboundSchema = z.object({
    accessGroupId: z.string(),
});
/**
 * @internal
...
export function roles2ToJSON(roles2) {
    return JSON.stringify(Roles2$outboundSchema.parse(roles2));
}
export function roles2FromJSON(jsonString) {
    return safeParse(jsonString, (x) => Roles2$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'Roles2' from JSON`);
}
/** @internal */
export const Roles1$inboundSchema = z
    .nativeEnum(Roles1);
/** @internal */
export const Roles1$outboundSchema = Roles1$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
/** @internal */
export const Roles$outboundSchema = z.union([z.lazy(() => Roles2$outboundSchema), Roles1$outboundSchema]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
export const PatchTeamSaml$inboundSchema = z.object({
    ...
    roles: z.record(z.union([z.lazy(() => Roles2$inboundSchema), Roles1$inboundSchema])).optional(),
});
/** @internal */
export const PatchTeamSaml$outboundSchema = z.object({
    enforced: z.boolean().optional(),
    roles: z.record(z.union([z.lazy(() => Roles2$outboundSchema), Roles1$outboundSchema])).optional(),
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
