...
export type ListDeploymentAliasesProtectionBypass = ListDeploymentAliasesProtectionBypass1 | ListDeploymentAliasesProtectionBypass3 | ListDeploymentAliasesProtectionBypass4 | ListDeploymentAliasesProtectionBypass2;
/**
...
export type ListDeploymentAliasesAliases = {
     ...
     */
    protectionBypass?: {
        [k: string]: ListDeploymentAliasesProtectionBypass1 | ListDeploymentAliasesProtectionBypass3 | ListDeploymentAliasesProtectionBypass4 | ListDeploymentAliasesProtectionBypass2;
    } | undefined;
};
/**
...
/** @internal */
export type ListDeploymentAliasesProtectionBypass$Outbound = ListDeploymentAliasesProtectionBypass1$Outbound | ListDeploymentAliasesProtectionBypass3$Outbound | ListDeploymentAliasesProtectionBypass4$Outbound | ListDeploymentAliasesProtectionBypass2$Outbound;
/** @internal */
...
/** @internal */
export declare const ListDeploymentAliasesAliases$inboundSchema: z.ZodType<ListDeploymentAliasesAliases, z.ZodTypeDef, unknown>;
/** @internal */
export type ListDeploymentAliasesAliases$Outbound = {
    ...
    redirect?: string | null | undefined;
    protectionBypass?: {
        [k: string]: ListDeploymentAliasesProtectionBypass1$Outbound | ListDeploymentAliasesProtectionBypass3$Outbound | ListDeploymentAliasesProtectionBypass4$Outbound | ListDeploymentAliasesProtectionBypass2$Outbound;
    } | undefined;
};
/** @internal */
export declare const ListDeploymentAliasesAliases$outboundSchema: z.ZodType<ListDeploymentAliasesAliases$Outbound, z.ZodTypeDef, ListDeploymentAliasesAliases>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ListDeploymentAliasesAliases$ {
    /** @deprecated use `ListDeploymentAliasesAliases$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ListDeploymentAliasesAliases, z.ZodTypeDef, unknown>;
    /** @deprecated use `ListDeploymentAliasesAliases$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ListDeploymentAliasesAliases$Outbound, z.ZodTypeDef, ListDeploymentAliasesAliases>;
    /** @deprecated use `ListDeploymentAliasesAliases$Outbound` instead. */
    type Outbound = ListDeploymentAliasesAliases$Outbound;
}
export declare function listDeploymentAliasesAliasesToJSON(listDeploymentAliasesAliases: ListDeploymentAliasesAliases): string;
export declare function listDeploymentAliasesAliasesFromJSON(jsonString: string): SafeParseResult<ListDeploymentAliasesAliases, SDKValidationError>;
/** @internal */
