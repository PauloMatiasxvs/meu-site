...
/** @internal */
export declare const GetFirewallConfigOwasp$inboundSchema: z.ZodType<GetFirewallConfigOwasp, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const GetFirewallConfigOwasp$outboundSchema: z.ZodType<GetFirewallConfigOwasp$Outbound, z.ZodTypeDef, GetFirewallConfigOwasp>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetFirewallConfigOwasp$ {
    /** @deprecated use `GetFirewallConfigOwasp$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetFirewallConfigOwasp, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetFirewallConfigOwasp$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetFirewallConfigOwasp$Outbound, z.ZodTypeDef, GetFirewallConfigOwasp>;
    /** @deprecated use `GetFirewallConfigOwasp$Outbound` instead. */
    type Outbound = GetFirewallConfigOwasp$Outbound;
}
export declare function getFirewallConfigOwaspToJSON(getFirewallConfigOwasp: GetFirewallConfigOwasp): string;
export declare function getFirewallConfigOwaspFromJSON(jsonString: string): SafeParseResult<GetFirewallConfigOwasp, SDKValidationError>;
/** @internal */
export declare const VerifiedBotsBypass$inboundSchema: z.ZodType<VerifiedBotsBypass, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const VerifiedBotsBypass$outboundSchema: z.ZodType<VerifiedBotsBypass$Outbound, z.ZodTypeDef, VerifiedBotsBypass>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace VerifiedBotsBypass$ {
    /** @deprecated use `VerifiedBotsBypass$inboundSchema` instead. */
    const inboundSchema: z.ZodType<VerifiedBotsBypass, z.ZodTypeDef, unknown>;
    /** @deprecated use `VerifiedBotsBypass$outboundSchema` instead. */
    const outboundSchema: z.ZodType<VerifiedBotsBypass$Outbound, z.ZodTypeDef, VerifiedBotsBypass>;
    /** @deprecated use `VerifiedBotsBypass$Outbound` instead. */
    type Outbound = VerifiedBotsBypass$Outbound;
}
export declare function verifiedBotsBypassToJSON(verifiedBotsBypass: VerifiedBotsBypass): string;
export declare function verifiedBotsBypassFromJSON(jsonString: string): SafeParseResult<VerifiedBotsBypass, SDKValidationError>;
/** @internal */
