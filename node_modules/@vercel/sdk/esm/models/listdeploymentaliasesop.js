...
/** @internal */
export const ListDeploymentAliasesAliases$inboundSchema = z.object({
    uid: z.string(),
    alias: z.string(),
...
/** @internal */
export const ListDeploymentAliasesAliases$outboundSchema = z.object({
    uid: z.string(),
    alias: z.string(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var ListDeploymentAliasesAliases$;
(function (ListDeploymentAliasesAliases$) {
    /** @deprecated use `ListDeploymentAliasesAliases$inboundSchema` instead. */
    ListDeploymentAliasesAliases$.inboundSchema = ListDeploymentAliasesAliases$inboundSchema;
    /** @deprecated use `ListDeploymentAliasesAliases$outboundSchema` instead. */
    ListDeploymentAliasesAliases$.outboundSchema = ListDeploymentAliasesAliases$outboundSchema;
})(ListDeploymentAliasesAliases$ || (ListDeploymentAliasesAliases$ = {}));
export function listDeploymentAliasesAliasesToJSON(listDeploymentAliasesAliases) {
    return JSON.stringify(ListDeploymentAliasesAliases$outboundSchema.parse(listDeploymentAliasesAliases));
}
export function listDeploymentAliasesAliasesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ListDeploymentAliasesAliases$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ListDeploymentAliasesAliases' from JSON`);
}
/** @internal */
