...
export const ErrorT$inboundSchema = z
    ...
    message: z.literal("One of the provided values in the request query, body or headers is invalid").optional(),
});
/** @internal */
export const ErrorT$outboundSchema = z.object({
    code: z.literal("bad_request").default("bad_request"),
    message: z.literal("One of the provided values in the request query, body or headers is invalid").default("One of the provided values in the request query, body or headers is invalid"),
});
/**
 * @internal
