 ...
 */
export declare const GetProjectMembersResponseBodyRole: {
 ...
 * Role of this user in the project.
 */
export type GetProjectMembersResponseBodyRole = ClosedEnum<typeof GetProjectMembersResponseBodyRole>;
/**
 * Role of this user in the project.
 */
 ...
 * Paginated list of members for the project.
 */
export type GetProjectMembersResponseBody = GetProjectMembersResponseBody1 | GetProjectMembersResponseBody2;
/** @internal */
...
/** @internal */
export declare const GetProjectMembersResponseBodyRole$inboundSchema: z.ZodNativeEnum<typeof GetProjectMembersResponseBodyRole>;
/** @internal */
export declare const GetProjectMembersResponseBodyRole$outboundSchema: z.ZodNativeEnum<typeof GetProjectMembersResponseBodyRole>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetProjectMembersResponseBodyRole$ {
...
/** @internal */
export type GetProjectMembersResponseBody$Outbound = GetProjectMembersResponseBody1$Outbound | GetProjectMembersResponseBody2$Outbound;
/** @internal */
