...
/** @internal */
export const AdditionalRoles$inboundSchema = z.nativeEnum(AdditionalRoles);
/** @internal */
export const AdditionalRoles$outboundSchema = AdditionalRoles$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var AdditionalRoles$;
(function (AdditionalRoles$) {
    /** @deprecated use `AdditionalRoles$inboundSchema` instead. */
    AdditionalRoles$.inboundSchema = AdditionalRoles$inboundSchema;
    /** @deprecated use `AdditionalRoles$outboundSchema` instead. */
    AdditionalRoles$.outboundSchema = AdditionalRoles$outboundSchema;
