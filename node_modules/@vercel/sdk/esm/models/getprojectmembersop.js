...
/** @internal */
export const GetProjectMembersResponseBodyRole$inboundSchema = z.nativeEnum(GetProjectMembersResponseBodyRole);
/** @internal */
export const GetProjectMembersResponseBodyRole$outboundSchema = GetProjectMembersResponseBodyRole$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var GetProjectMembersResponseBodyRole$;
(function (GetProjectMembersResponseBodyRole$) {
    /** @deprecated use `GetProjectMembersResponseBodyRole$inboundSchema` instead. */
    GetProjectMembersResponseBodyRole$.inboundSchema = GetProjectMembersResponseBodyRole$inboundSchema;
    /** @deprecated use `GetProjectMembersResponseBodyRole$outboundSchema` instead. */
    GetProjectMembersResponseBodyRole$.outboundSchema = GetProjectMembersResponseBodyRole$outboundSchema;
})(GetProjectMembersResponseBodyRole$ || (GetProjectMembersResponseBodyRole$ = {}));
/** @internal */
