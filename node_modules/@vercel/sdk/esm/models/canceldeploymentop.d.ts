...
export type CancelDeploymentGitSource = GitSource6 | GitSource8 | CancelDeploymentGitSource1 | CancelDeploymentGitSource3 | CancelDeploymentGitSource2 | CancelDeploymentGitSource4 | CancelDeploymentGitSource5 | GitSource7 | GitSource9;
...
export type CancelDeploymentRoutes = CancelDeploymentRoutes3 | CancelDeploymentRoutes2 | CancelDeploymentRoutes1;
...
export type CancelDeploymentMicrofrontends = CancelDeploymentMicrofrontends1 | CancelDeploymentMicrofrontends2;
/**
...
export type CancelDeploymentResponseBody = {
    ...
    gitSource?: GitSource6 | GitSource8 | CancelDeploymentGitSource1 | CancelDeploymentGitSource3 | CancelDeploymentGitSource2 | CancelDeploymentGitSource4 | CancelDeploymentGitSource5 | GitSource7 | GitSource9 | undefined;
    name: string;
    meta: {
        [k: string]: string;
    };
    ...
    projectId: string;
    routes: Array<CancelDeploymentRoutes3 | CancelDeploymentRoutes2 | CancelDeploymentRoutes1> | null;
    ...
    microfrontends?: CancelDeploymentMicrofrontends1 | CancelDeploymentMicrofrontends2 | undefined;
};
/** @internal */
...
/** @internal */
export type CancelDeploymentGitSource$Outbound = GitSource6$Outbound | GitSource8$Outbound | CancelDeploymentGitSource1$Outbound | CancelDeploymentGitSource3$Outbound | CancelDeploymentGitSource2$Outbound | CancelDeploymentGitSource4$Outbound | CancelDeploymentGitSource5$Outbound | GitSource7$Outbound | GitSource9$Outbound;
/** @internal */
...
/** @internal */
export declare const CancelDeploymentRoutesHandle$outboundSchema: z.ZodNativeEnum<typeof CancelDeploymentRoutesHandle>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace CancelDeploymentRoutesHandle$ {
...
/** @internal */
export type CancelDeploymentRoutesMissing$Outbound = CancelDeploymentMissing1$Outbound | CancelDeploymentMissing2$Outbound;
/** @internal */
export declare const CancelDeploymentRoutesMissing$outboundSchema: z.ZodType<CancelDeploymentRoutesMissing$Outbound, z.ZodTypeDef, CancelDeploymentRoutesMissing>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace CancelDeploymentRoutesMissing$ {
    /** @deprecated use `CancelDeploymentRoutesMissing$inboundSchema` instead. */
    const inboundSchema: z.ZodType<CancelDeploymentRoutesMissing, z.ZodTypeDef, unknown>;
    /** @deprecated use `CancelDeploymentRoutesMissing$outboundSchema` instead. */
    const outboundSchema: z.ZodType<CancelDeploymentRoutesMissing$Outbound, z.ZodTypeDef, CancelDeploymentRoutesMissing>;
    /** @deprecated use `CancelDeploymentRoutesMissing$Outbound` instead. */
    type Outbound = CancelDeploymentRoutesMissing$Outbound;
}
...
/** @internal */
export type CancelDeploymentRoutes$Outbound = CancelDeploymentRoutes3$Outbound | CancelDeploymentRoutes2$Outbound | CancelDeploymentRoutes1$Outbound;
/** @internal */
...
/** @internal */
export type CancelDeploymentMicrofrontends$Outbound = CancelDeploymentMicrofrontends1$Outbound | CancelDeploymentMicrofrontends2$Outbound;
/** @internal */
...
export type CancelDeploymentResponseBody$Outbound = {
    ...
    errorStep?: string | undefined;
    passiveRegions?: Array<string> | undefined;
    gitSource?: GitSource6$Outbound | GitSource8$Outbound | CancelDeploymentGitSource1$Outbound | CancelDeploymentGitSource3$Outbound | CancelDeploymentGitSource2$Outbound | CancelDeploymentGitSource4$Outbound | CancelDeploymentGitSource5$Outbound | GitSource7$Outbound | GitSource9$Outbound | undefined;
    name: string;
    meta: {
        [k: string]: string;
    };
    ...
    plan: string;
    projectId: string;
    routes: Array<CancelDeploymentRoutes3$Outbound | CancelDeploymentRoutes2$Outbound | CancelDeploymentRoutes1$Outbound> | null;
    ...
    microfrontends?: CancelDeploymentMicrofrontends1$Outbound | CancelDeploymentMicrofrontends2$Outbound | undefined;
};
/** @internal */
